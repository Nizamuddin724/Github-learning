...
public class ReportServiceImpl implements EligibilityService {
	...
	@Autowired
	private EligibilityDetailsRespo eligRespo;

	@Override
	public List<String> getUniquePlanName() {
		return eligRespo.findPlanNames();
	}

	@Override
	public List<String> getUniquePalnStatuses() {
		return eligRespo.findPlanStatuses();
	}
	...
	public List<SearchResponse> search(SearchRequest request) {
		...
		LocalDate planEndDate=request.getPlanEndtDate();
		if(planStartDate != null) {
			queryBuilder.setPlanEndDate(planEndDate);
			
		}
		Example<EligibilityDetails> example=Example.of(queryBuilder);
		List<EligibilityDetails> entities=eligRespo.findAll();
